                        ...
                        case 'answer':
                          //  console.log('answer',messageData)
                            ...
                            if (!this.rooms[messageData.room].score[messageData.token]){
                                this.rooms[messageData.room].score[messageData.token] = {players:0, round:0, last:0, current:0, right:0, mistake:0, currentTime: new Date().valueOf() - this.rooms[messageData.room].currentTimeStamp}
                            }
                            ...
                            if (this.rooms[room].questions[this.rooms[room].currentTask].answer.toLowerCase().trim().indexOf(messageData.answer.toLowerCase())>=0){
                                if(!this.rooms[room].isFirstRightAnswer){
